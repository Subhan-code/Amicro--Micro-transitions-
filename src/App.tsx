...
export default function App() {
  ...
  return (
    <div className={`relative w-full min-h-screen flex flex-col font-sans antialiased transition-colors duration-300 ${theme === 'dark' ? 'bg-[#121212] text-[#ffffff] selection:bg-neutral-800' : 'bg-[#f8f9fa] text-black selection:bg-neutral-200'}`}>
      ...
      <header className="relative z-50 w-full pt-4 pb-4 px-6">
        <div className="relative z-[3] flex items-center justify-between gap-4 max-w-[1240px] mx-auto">
          <div className="flex items-center gap-[34px] min-w-0">
            <a href="https://github.com/Subhan-code/Amicro--Micro-transitions-" className={`inline-flex items-center gap-[4px] h-[35px] py-[5px] no-underline shrink-0 group transition-transform duration-400 ease-[cubic-bezier(0.22,1,0.36,1)] hover:scale-[1.02] ${theme === 'dark' ? 'text-white' : 'text-black'}`}>
            ...
            <nav className="hidden sm:flex items-center gap-[8px]">
              <a href="https://github.com/Subhan-code/Amicro--Micro-transitions-" className={`inline-flex items-center justify-center h-[36px] px-[13px] rounded-full text-[13px] font-medium leading-[16px] no-underline whitespace-nowrap transition-colors duration-150 ${theme === 'dark' ? 'text-white bg-[rgba(255,255,255,0.06)]' : 'text-black bg-neutral-200/60'}`}>Components</a>
              <a href="https://github.com/Subhan-code/Amicro--Micro-transitions-#readme" target="_blank" rel="noopener noreferrer" className={`inline-flex items-center justify-center h-[36px] px-[13px] rounded-full text-[13px] font-medium leading-[16px] no-underline whitespace-nowrap transition-colors duration-150 ${theme === 'dark' ? 'text-[rgba(202,202,202,0.7)] hover:text-white hover:bg-[rgba(255,255,255,0.06)]' : 'text-black hover:text-black hover:bg-neutral-200/60'}`}>Documentation</a>
            </nav>
          </div>
      ...
      <div className="relative z-10 flex-1 w-full max-w-[1240px] mx-auto px-6 flex flex-col items-center">
        ...
        <div className="mt-12 mb-16 text-center w-full flex flex-col items-center">
          ...
          <div className="flex items-center gap-3 mt-8">
            <motion.a 
              ...
              className={`inline-flex items-center justify-center gap-2 h-[40px] px-[20px] rounded-full text-[13px] font-medium no-underline transition-colors cursor-pointer ${theme === 'dark' ? 'bg-white text-black hover:bg-neutral-200' : 'bg-neutral-950 text-white hover:bg-neutral-800'}`}
            >
              <motion.div 
                variants={{
          ...
          <div className="flex items-center gap-2 sm:gap-4 mt-10">
            <div className={`flex items-center p-1 rounded-full border shadow-inner transition-colors duration-300 ${theme === 'dark' ? 'bg-[#181818] border-white/5' : 'bg-neutral-200/50 border-neutral-300/30'}`}>
              <button
                ...
                className={`flex items-center gap-2 px-4 py-1.5 rounded-full text-[13px] font-medium transition-colors cursor-pointer ${
                  sortBy === 'alphabetical' 
        ...
        <div 
          id="component-grid"
          className={`
            w-full flex justify-center gap-[24px] scroll-mt-24
        ...
        >
          <AnimatePresence mode="popLayout">
            {displayedButtons.map((button) => (
              ...
              >
                {layout === 'grid' ? (
                  <div className={`relative w-[320px] h-[268px] rounded-[24px] transition-all duration-300 group ${theme === 'dark' ? 'bg-[#181818] shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] hover:bg-[#202020]' : 'bg-white shadow-[0_4px_20px_rgba(0,0,0,0.04),0_1px_3px_rgba(0,0,0,0.02)] border border-neutral-100/80 hover:shadow-[0_6px_24px_rgba(0,0,0,0.06)] text-black'}`}>
                    <div className={`absolute left-[12px] top-[12px] w-[296px] h-[188px] rounded-[14px] overflow-hidden flex items-center justify-center transition-colors duration-300 ${theme === 'dark' ? 'bg-[#131313]' : 'bg-[#f4f4f6]'}`}>
                    ...
                    <div className="absolute left-[20px] bottom-[14px] w-[calc(100%-80px)] flex flex-col gap-[2px]">
                      <div className={`text-[13px] font-medium leading-[18px] transition-colors ${theme === 'dark' ? 'text-[#ededed]' : 'text-black'}`}>{button.label}</div>
                    ...
                    <button 
                      ...
                      type="button" 
                      className={`absolute right-[20px] bottom-[12px] w-[32px] h-[32px] rounded-full flex items-center justify-center transition-colors cursor-pointer focus-visible:outline focus-visible:outline-2 ${theme === 'dark' ? 'bg-white/[0.08] hover:bg-white/[0.12] text-[#ededed]/60 hover:text-[#ededed]' : 'bg-neutral-100 hover:bg-neutral-200 text-black hover:text-black'}`} 
